          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul class="space-y-2 text-gray-400">
                <li><a href="/src/static/about-uba.html" class="hover:text-white transition-colors">About UBA</a></li>
                <li><a href="/src/static/villages.html" class="hover:text-white transition-colors">Adopted Villages</a></li>
                <li><a href="/src/static/projects.html" class="hover:text-white transition-colors">Projects</a></li>
                <li><a href="/src/static/gallery.html" class="hover:text-white transition-colors">Gallery</a></li>
                <li><a href="/src/static/contact.html" class="hover:text-white transition-colors">Contact</a></li>
              </ul>
            </div>
