    ...
    <nav class="bg-gradient-to-r from-teal-900 via-gov-primary to-teal-900 text-white shadow-lg sticky top-0 z-50">
          ...
          <div class="hidden lg:block">
            <div class="ml-10 flex items-center space-x-8">
              ...
              <div class="relative group">
                ...
                <div class="absolute left-0 pt-2 w-48 hidden group-hover:block transition-all duration-200 z-50">
                  <div class="rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 py-1" role="menu">
                    <a href="/about-uba.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">About UBA</a>
                    <a href="/about-svpcet.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">About SVPCET UBA</a>
                    <a href="/team.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Coordinators & Team</a>
                  </div>
                </div>
              </div>
              ...
              <div class="relative group">
                ...
                <div class="absolute left-0 pt-2 w-48 hidden group-hover:block transition-all duration-200 z-50">
                  <div class="rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 py-1" role="menu">
                    <a href="/participation.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Student Corner</a>
                    <a href="/events.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Events & Visits</a>
                  </div>
                </div>
              </div>
      ...
      <div class="hidden lg:hidden bg-gradient-to-r from-teal-900 via-gov-primary to-teal-900 border-t border-green-800" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <a href="/about-svpcet.html" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-green-700">About SVPCET</a>
          <a href="/villages.html" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-green-700">Villages</a>
          <a href="/projects.html" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-green-700">Projects</a>
          <a href="/contact.html" class="block px-3 py-2 rounded-md text-base font-medium text-white bg-gov-accent hover:bg-orange-600 mt-4">Contact Us</a>
        </div>
      </div>
    </nav>
  `;
